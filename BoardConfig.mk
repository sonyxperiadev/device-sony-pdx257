...
BOARD_SUPER_PARTITION_ERROR_LIMIT := 18803064832

# DYNAMIC_PARTITIONS_SIZE = (SUPER_PARTITION_SIZE / 2) - 4MiB
BOARD_SOD_DYNAMIC_PARTITIONS_SIZE := 9659482112

# Reserve space for data encryption (0x1864E8F000-0x4000)
BOARD_USERDATAIMAGE_PARTITION_SIZE := 104772186112
